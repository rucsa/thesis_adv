...
class ClientPortfolio(object):
    ...
    def pretty_print_portfolio(self, allSecurities):
        ...
        sectors = ['Consumer, Non-cyclical', 'Technology', 'Financial',
        ...
        for k, v in self.portfolio.items():
            ...
            if current_security['Asset'] == 'Equity':
                print ("{} .. {} .. {} ..... {} .. {} %".format(current_security['Asset'], current_security['Sector'], current_security['Region'], k, v))
        for k, v in self.portfolio.items():
            current_security = allSecurities[k]
            if current_security['Asset'] == 'Bond':
                print ("{} .. {} .. {} ..... {} .. {} %".format(current_security['Asset'], current_security['Sector'], current_security['Region'], k, v))
        print ("{} ..... {} %".format('CASH', self.cash))
        stocks, bonds = self.current_asset_allocation(allSecurities)
